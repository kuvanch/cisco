                ...
                <div className="information-video">
                    <div className="information-part" data-aos="fade-down-right" data-aos-duration="1000">
                        ...
                        <div className="inf">
                            ...
                            <p className="information-p">
                            Доставка исправных запчастей по территории Казахстан осуществляется компанией EVENTRA SERVICE LLC. Непрерывное пополнение склада запасных компонентов в Нур-Султане и Алматы, что позволяет оперативно обрабатывать сервисные кейсы и минимизировать простои техники заказчика.
                            </p>
                        </div>
                        <div className="inf">
                            <div className="vl3"></div>
                            <p className="information-p">
                                <li type="square">Сервис по гарантии предоставляется бесплатно только на период гарантийного срока и при выявлении поломки по гарантийному случаю. </li>	
                                <li type="disc">  В случае дефицита компонента, обслуживание системы заказчика может занять до 30 рабочих дней.</li>											
                            </p>
                        </div>
                        <div className="inf">
                            <div className="vl3"></div>
                            <div className="information-p">
                                Доступен новый вид доставки – NCD для Алматы и Нур-Султана для этих городов доступна 4 часовая поддержка. Смотри приложение.
                                <a href="https://www.youtube.com/watch?v=J57lEUCH4cU"> 
